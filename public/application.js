...
var onSignUp = function onSignUp(event) {
  ...
  authApi.signUp(data).then(function (signUpResponse) {
...
var gameTie = function gameTie() {
  if ($('#s1').text() && $('#s2').text() && $('#s3').text() && $('#s4').text() && $('#s5').text() && $('#s6').text() && $('#s7').text() && $('#s8').text() && $('#s9').text() === true) {
...
var onClick = function onClick() {
  ...
  // $('.message').text('Player X wins')
  // gameOver = true
  $('#s3').text() === 'X' && $('#s6').text() === 'X' && $('#s9').text() === 'X') {
    $('.message').text('Player X wins');
    gameOver = true;
  } else if ( // (($('#s3').text() && $('#s6').text() && $('#s9').text()) === '0') {
  // $('.message').text('Player O wins')
  // gameOver = true
  $('#s3').text() === 'O' && $('#s6').text() === 'O' && $('#s9').text() === 'O') {
    $('.message').text('Player O wins');
    gameOver = true;
  } else if ( // (($('#s7').text() && $('#s5').text() && $('#s3').text()) === 'X') {
  // $('.message').text('Player X wins')
  // gameOver = true
  $('#s7').text() === 'X' && $('#s5').text() === 'X' && $('#s3').text() === 'X') {
    $('.message').text('Player X wins');
    gameOver = true;
  } else if ( // (($('#s7').text() && $('#s5').text() && $('#s3').text()) === '0') {
  // $('.message').text('Player O wins')
  // gameOver = true
  $('#s7').text() === 'O' && $('#s5').text() === 'O' && $('#s3').text() === 'O') {
    $('.message').text('Player O wins');
    gameOver = true;
  } else if ( // (($('#s1').text() && $('#s5').text() && $('#s8').text()) === 'X') {
  // $('.message').text('Player X wins')
  // gameOver = true
  $('#s1').text() === 'X' && $('#s5').text() === 'X' && $('#s8').text() === 'X') {
    $('.message').text('Player X wins');
    gameOver = true;
  } else if ( // (($('#s1').text() && $('#s5').text() && $('#s8').text()) === '0') {
  // $('.message').text('Player O wins')
  // gameOver = true
  $('#s1').text() === 'O' && $('#s5').text() === 'O' && $('#s8').text() === 'O') {
    $('.message').text('Player O wins');
    gameOver = true;
